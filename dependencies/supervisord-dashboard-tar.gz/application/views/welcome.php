...
<head>
	<meta charset="utf-8">
	<title>Mode Supervisord Monitoring Dashboard</title>
...
<body>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
		  ...
		  <a class="brand" href="<?php echo site_url('');?>">Mode Supervisord Dashboard</a>
		...
		<li><a href="<?php echo site_url();?>">Refresh <b id="refresh">(<?php echo $this->config->item('refresh');?>)</b> &nbsp;</a></li>
              <li><a href="mailto:talos-dev@mode.com">Contact</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
    ...
    $('#product').change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('welcome/getenv'); ?>",
    ...
    $('#env').change(function() {
        ...
        $.ajax({
            ...
            data: {product: product, env: env, env_flag: 1},
             success: function (env_product) {
                $('#inner-container').html(env_product);
            },
        });
